          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <form action="<?php echo base_url('Main/filter_wilayah/') ?>" method="POST">
                    <div class="input-group input-group-sm">
                ...
                <div class="box-body">            
				  <table id="data" class="table table-bordered table-striped table-scalable">
                    ...
                    if($df->kode_toko == $data_cust->kode_toko) { ?>
                <tr style="color:blue; font-weight:bold; font-size:18px;">
                    ...
                    <?php } ?>
                    <td><a href="<?php echo base_url('Filter/delt_toko/'.$df->no_urut); ?>" class="btn btn-primary pull-right"><i class="fa fa-trash-o"></i> Hapus Toko</a></td>
                </tr>
                  <?php } else { ?>
                <tr>
                    <?php $data = $this->db->query("SELECT * FROM tb_filter_data INNER JOIN tb_ruang_lingkup ON tb_filter_data.ruang_lingkup = tb_ruang_lingkup.kode_ruang WHERE tb_ruang_lingkup.kode_ruang = '$df->ruang_lingkup'")->row(); 
