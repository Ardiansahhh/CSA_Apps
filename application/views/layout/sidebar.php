      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('Main'); ?>"><i class="fa fa-user"></i>Data Pelanggan</a></li>
            <li class="active"><a href="<?php echo base_url('Salesman'); ?>"><i class="fa fa-user"></i>Data Salesman</a></li>
            <li class="active"><a href="<?php echo base_url('Area'); ?>"><i class="fa  fa-truck"></i>Ruang Lingkup</a></li>
